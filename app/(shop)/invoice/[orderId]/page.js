    ...
    <div className="max-w-2xl mx-auto p-8 bg-white text-[#2B1B14]">
      <div className="flex justify-between items-start border-b-2 border-[#D4AF37]/40 pb-4 mb-6">
        <div>
          ...
          <p className="text-sm text-[#2B1B14]/60">{settings?.address || 'V.T Mani nagar, Madurai Dt, Tamil Nadu'}</p>
      ...
      <p className="text-center text-xs text-[#2B1B14]/40 mt-10">Thank you for shopping with Rani Sarees!</p>
